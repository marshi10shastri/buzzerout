...
function post_template_no_post(feedId) {
    return `<div class="col-sm-12">
        ...
        <div class="iq-card-body" data-toggle="modal" data-target="#post-modal">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="user-img">
                    ...
                    <img id="post-write-userimage" src="images/user/1.jpg" alt="userimg" class="avatar-60 rounded-circle">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="user-img">
                                ...
                                <img id="post-write-userimage-inside" src="images/user/1.jpg" alt="userimg" class="avatar-60 rounded-circle img-fluid">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="user-img mr-3">
                                        ...
                                        <img id="post-userimage-story" src="images/user/1.jpg" alt="userimg" class="avatar-60 rounded-circle img-fluid">
